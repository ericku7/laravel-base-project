(function ($) {
    ...
    $.fn.initial = function (options) {
        ...
        // Defining Colors
        var colors = ["#1abc9c", "#16a085", "#f1c40f", "#f39c12", "#2ecc71", "#009688", "#e67e22", "#d35400", "#3498db", "#2980b9", "#e74c3c", "#c0392b", "#9b59b6", "#8e44ad", "#bdc3c7", "#34495e", "#ff9500", "#132f8b", "#7f8c8d", "#ec87bf", "#d870ad", "#f69785", "#9ba37e", "#b49255", "#b49255", "#a94136"];
        ...
        return this.each(function () {
            ...
            var settings = $.extend({
                ...
                fontSize: 20,
                fontWeight: 400,
                fontFamily: 'AvertaStd-Regular,Helvetica Neue,Helvetica,Arial,sans-serif',
                radius: 0
            }, options);
