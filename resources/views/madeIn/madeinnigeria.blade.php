@include('layouts.madeinHeader')
<div class="page-title">
    <h2><i class="flag-icon flag-icon-ng"></i> &nbsp; Made in  Nigeria</h2>
</div>
<div class="container">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav sidebar-tabs nav-tabs">
                        <li class="cat-list active">
                            <a class="nav-link active" id="T-shirts-tab" data-toggle="tab" href="#T-shirts" role="tab" role="tab">Womens</a>
                        </li>
                        <li class="cat-list">
                            <a class="nav-link" id="Trousers-tab" data-toggle="tab" href="#Trousers" role="tab">Mens</a>
                        </li>
                        <li class="cat-list">
